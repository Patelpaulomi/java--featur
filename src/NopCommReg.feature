Feature:  Nopcommerce Registration
  ...
  Scenario Outline: I should be able to select Day, Month and year from down list of Date od birth field
    Given        I am on Date of Birth field of your person Detail section
